...
CREATE TABLE "Persona" (
    ...
    "inheritanceHousing" DOUBLE PRECISION NOT NULL,
    "inheritanceCompany" DOUBLE PRECISION NOT NULL,
    "inheritanceFinancial" DOUBLE PRECISION NOT NULL,
    "inheritanceTaxable" DOUBLE PRECISION NOT NULL,
    "inheritanceTax" DOUBLE PRECISION NOT NULL,
